 ...
 * 地址选择
 */
public class AddressChooseActivity extends BasisActivity {
...
//        mRecyclerView.setLoadingMoreEnabled(false);
        setTitle(R.string.order_choose_address);
...
//        params.put("sortId", sortDataBean.getSortId());
    ...
    MyHttpListener myHttpListener = new MyHttpListener() {
        ...
        public void onSuccess(int httpWhat, Object result) {
            ...
            if(currentPosition == -1){
                currentPosition = mListBean.getDefaultPosition();
            }
            setListView();
        }
    ...
    public class MyAdapterList extends RecyclerView.Adapter<MyAdapterList.ViewHolder> {
        ...
        public ViewHolder onCreateViewHolder(ViewGroup viewGroup, int viewType) {
            View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.address_choose_list_item, viewGroup, false);
        ...
        public void onBindViewHolder(ViewHolder viewHolder, int position) {
            ...
            viewHolder.view_edit.setTag(data);
...
//                    data.toDetail(mContext);
                final AddressListData data = (AddressListData) v.getTag();
                DialogUtils.DialogTwo(mContext, "",
                        mContext.getString(R.string.sure_receiver_address),
            ...
            public void edit(View v) {
                    AddressListData data = (AddressListData) v.getTag();
//                    data.toDetail(mContext);
