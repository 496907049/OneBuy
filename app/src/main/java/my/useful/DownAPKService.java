        ...
        HttpRestClient.download(file_url, new FileAsyncHttpResponseHandler(file) {
            ...
            public void onSuccess(int i, Header[] headers, File file) {
                ...
                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N) {
                    ...
                    uri = FileProvider.getUriForFile(BasisApp.getInstance(), "com.app.onebuy.onebuyprovider", file);
                } else {
                    installIntent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
...
//				uri = Uri.fromFile(file);
                ...
                PendingIntent mPendingIntent = PendingIntent.getActivity(
                        DownAPKService.this, 0, installIntent, 0);
...
//				LogUtil.i(""+APK_dir);
    ...
    private void installApk(Context context, File file) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N) {
            ...
            Uri contentUri = FileProvider.getUriForFile(getApplicationContext(), "com.app.onebuy.onebuyprovider", file);
