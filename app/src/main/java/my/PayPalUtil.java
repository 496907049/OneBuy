...
/**
 * Created by otis on 2018/6/21.
 */

public class PayPalUtil {

    private static final String TAG = "PayPalUtil";
    //配置何种支付环境，一般沙盒，正式
...
//.merchantUserAgreementUri(Uri.parse("https://www.example.com/legal"));
    private static PayPalUtil PayPalUtil;
     ...
     * @param context
     */
    public void doPayPalPay(Context context,String money,String payName) {
    /*
     ...
     */
        PayPalPayment thingToBuy = getStuffToBuy(PayPalPayment.PAYMENT_INTENT_SALE,money,payName);
    /*
    ...
    /*
         ...
         */
    private PayPalPayment getStuffToBuy(String paymentIntent,String money,String payName) {
...
//        return payment;
        return new PayPalPayment(new BigDecimal(""+money), "USD", ""+payName,
                paymentIntent);
    }
...
//    作者：妖孽那里逃
//    链接：https://www.jianshu.com/p/8b96c8d8819b
//    來源：简书
